...
#  Buttons
    ...
    # Scanning parameters
     ...
     # save image Button
        self.saveimageButton = QtGui.QCheckBox('') #QtGui.QPushButton('Save Picture Andor')
        self.saveimageButton.clicked.connect(self.get_save_frame)
        self.saveimageButton.setToolTip('Guarda cada foto de la Andor, con el doble de tamaño del ROI.')
...
# Interface
        ...
        subgrid.addWidget(self.laser_on_auto,          1, 2)
        ...
        subgrid.addWidget(self.saveimageButton,        8, 3)
...
class Backend(QtCore.QObject):
    ...
    def start_scan_step_xy(self, laser, mode_printing, name_folder):  
      ...
      #  time.sleep(1)
        ...
        if self.laser_on_option:  #Medir con laser prendido, apagar para Scattering
    ...
    def save_picture_spectrum(self, i, j, image):
        ...
        filename = "Picture_Andor_i%04d_j%04d.tiff" % (int(i), int(j))
    ...
    @pyqtSlot(bool)            
    def save_picture_spectrum_bool(self, savebool):
        self.save_picture_bool = savebool
    ...
    def make_connection(self, frontend):
        ...
        frontend.saveSignal.connect(self.save_picture_spectrum_bool)
