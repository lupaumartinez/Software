...
class Frontend(QtGui.QFrame):
    ...
    def setUpGUI(self):
        ...
        pixel_size = QtGui.QLabel(str(pixel_size_canon))
        
        cursor_x_Label = QtGui.QLabel('Cursor X (# pixel)')
        self.cursor_x = QtGui.QLabel('NaN')
        cursor_y_Label = QtGui.QLabel('Cursor Y (# pixel)')
        ...
        layout.addWidget(pixel_size,             7, 2)
    ...
    def set_mov_y(self):
        ...
        pixel_y = np.round(float(self.distancex_Edit.text())/pixel_size_canon, 3)
    ...
    def set_mov_x(self):
        ...
        pixel_x = np.round(float(self.distancey_Edit.text())/pixel_size_canon, 3)
...
class Backend(QtCore.QObject):
    ...
    def go_initial_cursor(self):
        ...
        x_cursor_initial = self.total_pixel_x
        y_cursor_initial = 0
    ...
    def real_cursor(self, pos):
        ...
        x_new_cursor = round(self.x_cursor_reference - distance_x, 3)
        y_new_cursor = round(self.y_cursor_reference + distance_y, 3)
