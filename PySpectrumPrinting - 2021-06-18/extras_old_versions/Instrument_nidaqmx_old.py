...
shutterschan = [9, 10, 11, 12]  # digital output (do) of shutters, el de 808nm es mentira

flipper532chan = 7 # digital output (do) of flipper Notch 532 nm

PDchanBS = 6 #chanel analog of photodiode beam splitter
PDchans = [0, 1, 2, PDchanBS]  #  analog input (ai) of photodiodos
PD_channels = {shutters[0]: 0, shutters[1]: 1, shutters[2]: 1, shutters[3]: 2, 'BS': PDchanBS}  #si rojo e infrarrojo comparten fotodiodo en el set up
...
def Flipper_notch532(desired_position):
...
def channels_photodiodos(rate, samps_per_chan):
