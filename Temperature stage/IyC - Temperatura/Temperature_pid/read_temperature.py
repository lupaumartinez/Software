...
class Backend(QtCore.QObject):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.time_refresh = 0.5 #segundos
    ...
    def get_values(self):
        ...
        value = self.myArduino.readline().strip()
    ...
    def get_values_dc(self, value):
        ...
        new_time = self.step2*self.time_refresh

        self.timeaxis2.append(new_time)
        self.dataaxis2.append(value_dc)
        self.step2 += 1

        data_dc = [self.step2, self.timeaxis2, self.dataaxis2]
        self.data_dcSignal.emit(data_dc)
